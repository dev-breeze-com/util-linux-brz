...
struct fdisk_batch_context {
	int enabled;  /* batch mode true/false */
	int command;  /* batch current command */
	int curline;  /* batch current line */
	int alignment;  /* batch sector alignment */
	struct fdisk_batch_record *lines[ FDISK_MAXPART ]; /* batch partition data */
};
...
struct fdisk_context {
	...
	struct fdisk_batch_context	batch;	/* for batch commands */
